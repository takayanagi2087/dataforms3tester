...
/**
 * DeveloperEditForm フォームテスト要素。 
 */
public class DeveloperEditFormTestElement extends EditFormTestElement {
	/**
	 * フォームID。
	 */
	 ...
	 * ユーザインポートフラグ。
	 */
	public static final String ID_USER_IMPORT_FLAG = "userImportFlag";
	 ...
	 */
	public DeveloperEditFormTestElement(final Browser browser, final TestElement parent, final WebElement webElement) {
	...
	/**
	 * ユーザインポートフラグのテスト要素を取得します。
	 * @return ユーザインポートフラグのテスト要素。
	 */
	public FieldTestElement getUserImportFlag() {
		return this.getField(ID_USER_IMPORT_FLAG);
	}
	/**
