...
public class QueryGeneratorQueryFormSample001TestItem extends QueryGeneratorQueryFormTestItem {
	/**
	 * テスト条件。
	 */
	 ...
	 * コンストラクタ。
	 */
	public QueryGeneratorQueryFormSample001TestItem() {
	...
	protected ResultType test(Browser browser) throws Exception {
		...
		QueryGeneratorQueryFormTestElement f = p.getQueryGeneratorQueryForm();
