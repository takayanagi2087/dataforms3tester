...
import jp.dataforms.test.element.devtool.query.page.QueryExecutorQueryResultFormTestElement;
...
public class QueryExecutorQueryResultFormSample001TestItem extends QueryExecutorQueryResultFormTestItem {
	/**
	 * テスト条件。
	 */
	 ...
	 * コンストラクタ。
	 */
	public QueryExecutorQueryResultFormSample001TestItem() {
	...
	protected ResultType test(Browser browser) throws Exception {
		...
		QueryExecutorQueryResultFormTestElement f = p.getQueryExecutorQueryResultForm();
