...
public class QueryGeneratorEditFormSample001TestItem extends QueryGeneratorEditFormTestItem {
	/**
	 * テスト条件。
	 */
	 ...
	 * コンストラクタ。
	 */
	public QueryGeneratorEditFormSample001TestItem() {
	...
	protected ResultType test(Browser browser) throws Exception {
		...
		QueryGeneratorEditFormTestElement f = p.getQueryGeneratorEditForm();
