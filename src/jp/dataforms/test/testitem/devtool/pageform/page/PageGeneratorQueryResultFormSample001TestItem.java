...
public class PageGeneratorQueryResultFormSample001TestItem extends PageGeneratorQueryResultFormTestItem {
	/**
	 * テスト条件。
	 */
	 ...
	 * コンストラクタ。
	 */
	public PageGeneratorQueryResultFormSample001TestItem() {
