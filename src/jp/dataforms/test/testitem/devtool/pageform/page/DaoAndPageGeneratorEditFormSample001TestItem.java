...
public class DaoAndPageGeneratorEditFormSample001TestItem extends DaoAndPageGeneratorEditFormTestItem {
	/**
	 * テスト条件。
	 */
	 ...
	 * コンストラクタ。
	 */
	public DaoAndPageGeneratorEditFormSample001TestItem() {
