...
public class TableManagementQueryFormSample001TestItem extends TableManagementQueryFormTestItem {
	/**
	 * テスト条件。
	 */
	 ...
	 * コンストラクタ。
	 */
	public TableManagementQueryFormSample001TestItem() {
...
//		TableManagementQueryFormTestElement f = p.getTableManagementQueryForm();
