...
public class TableGeneratorEditFormSample001TestItem extends TableGeneratorEditFormTestItem {
	/**
	 * テスト条件。
	 */
	 ...
	 * コンストラクタ。
	 */
	public TableGeneratorEditFormSample001TestItem() {
	...
	protected ResultType test(Browser browser) throws Exception {
		...
		TableGeneratorEditFormTestElement f = p.getTableGeneratorEditForm();
