...
public class EnumQueryResultFormSample001TestItem extends EnumQueryResultFormTestItem {
	/**
	 * テスト条件。
	 */
	 ...
	 * コンストラクタ。
	 */
	public EnumQueryResultFormSample001TestItem() {
	...
	protected ResultType test(Browser browser) throws Exception {
		...
		EnumQueryResultFormTestElement f = p.getEnumQueryResultForm();
