...
public class UserQueryFormSample001TestItem extends UserQueryFormTestItem {
	/**
	 * テスト条件。
	 */
	 ...
	 * コンストラクタ。
	 */
	public UserQueryFormSample001TestItem() {
	...
	protected ResultType test(Browser browser) throws Exception {
		...
		UserQueryFormTestElement f = p.getUserQueryForm();
