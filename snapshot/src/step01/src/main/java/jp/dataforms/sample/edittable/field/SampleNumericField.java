...
/**
 * SampleNumericFieldフィールドクラス。
 *
 */
public class SampleNumericField extends NumericField {

	/**
	 * フィールドコメント。
	 */
	private static final String COMMENT = "数字";
	/**
	 * コンストラクタ。
	 */
	public SampleNumericField() {
		this(null);
	}
	/**
	 * コンストラクタ。
	 * @param id フィールドID。
	 */
	public SampleNumericField(final String id) {
		super(id, 10, 2);
